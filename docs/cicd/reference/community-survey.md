...
source: 2026-09-13 单文件初稿《DeepSeek Harness 社区 Jenkins CI_CD Pipeline 方案总结报告》的调研部分（该初稿已于 2026-09-14 拆分归档，调研部分逐字迁入本文件，架构部分改写为 ../architecture.md 与 ../engineering.md）
---

> **本文件是参考资料，不是本仓的方案。** 内容为对 DSH 社区 Jenkins 集成生态的调研摘录，
> 原样保留以便查阅；其中涉及的配置实例、插件清单等**未经本仓验证**。
> 本仓实际采用的方案见 [../architecture.md](../architecture.md) 与 [../engineering.md](../engineering.md)。
