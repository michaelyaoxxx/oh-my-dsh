...
| `plugins/` | 插件 submodule 集合（dsh-web pin `main`、dsh-better-sidebar pin tag `v0.18.1`、dsh-plugin-mineru pin `master`、modlens pin tag `v3.26.1`、dsh-automation pin tag `v0.1.7`），插件默认安装位置 |
